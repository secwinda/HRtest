<#assign mindList = userMind.getMindList(odeptCode) > 
	<#if mindList?size != 0>
		<tr style="height:35px;">
			<td class="pb5 pt5 head" align="center" style="background-color:#c7d9ef;font-weight:bold;width:10%;">部门</td>
			<td class="pb5 pt5 head" align="center" style="background-color:#c7d9ef;font-weight:bold;width:10%;">签意见人</td>
			<td class="pb5 pt5 head" align="center" style="background-color:#c7d9ef;font-weight:bold;width:15%;">办理环节</td>
			<td class="pb5 pt5 head" align="center" style="background-color:#c7d9ef;font-weight:bold;width:45%;">意见内容</td>
			<td class="pb5 pt5 head" align="center" style="background-color:#c7d9ef;font-weight:bold;width:120px;">签意见时间</td>
			<td class="pb5 pt5 head" align="center" style="background-color:#c7d9ef;font-weight:bold;width:10%;">意见类型</td>
		</tr>
