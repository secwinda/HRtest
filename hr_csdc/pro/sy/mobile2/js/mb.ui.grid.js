	...
	return tdRight.join('');
			...
			/*
				...
				if (_code == 'S_EMERGENCY') { // 紧急程度
					...
					case '20' :
					case '紧急' :
						emergencyArr.push("<img class='ui-li-icon' src='/jqm_test/server/images/yellowstar.png' />");
						break;
					case '3' :
					case '30' :
					case '特急' :
						emergencyArr.push("<img class='ui-li-icon' src='/jqm_test/server/images/redstar.png' />");
						break;
					case '1' :
					case '一般' :
					default :
						emergencyArr.push("<img class='ui-li-icon' src='/jqm_test/server/images/whitestar.png' />");
					}
